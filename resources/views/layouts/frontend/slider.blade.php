        ...
        <div class="row">
            <div class="col-12">
                <div class="slider-animate">
                    <div>
                        <div class="home-contain rounded-0 p-0 py-5">
                            <img src="{{ asset('data/slider.jpeg') }}" class="img-fluid bg-img blur-up lazyload"
                                alt="">
                            <div class="home-detail home-big-space p-center-left home-overlay position-relative">
                                <div class="container-fluid-lg">
                                    <div>
                                        <h6 class="ls-expanded theme-color text-uppercase">
                                            Mingalapar Pitbull Kennel
                                        </h6>
                                        <h1 class="heding-2">
                                            Mingalapar Pitbull Kennel
                                        </h1>
                                        ...
                                        <button
                                            ...
                                            Buy Now <i class="fa-solid fa-arrow-right icon"></i>
                                        </button>
                                    </div>
                                </div>
                            </div>
